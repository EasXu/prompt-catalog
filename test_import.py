...
# 7. augment — 自然语言智能增强
print("\n🧠 augment('草坪上有两个玩具和一个花盆，两个小孩在玩，远处有栅栏'):")
result = augment("草坪上有两个玩具和一个花盆，两个小孩在玩，远处有栅栏")
n = result.count(chr(10))
print(f"  匹配到 {n} 条预制提示词（玩具×2 + 花盆×1 + 儿童×2 + 栅栏×2~4）")
print(f"  输出前150字: {result[:150]}...")
